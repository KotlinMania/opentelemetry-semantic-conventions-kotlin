...
This file is the quick-reference operating contract for opentelemetry-semantic-conventions-kotlin. The longer
...
opentelemetry-semantic-conventions-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`opentelemetry-semantic-conventions`](https://crates.io/crates/opentelemetry-semantic-conventions). Upstream Rust is the behavioral oracle while the
