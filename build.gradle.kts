...
kotlin {
    ...
    val xcf = XCFramework("OpentelemetrySemanticConventions")

    macosArm64 {
        binaries.framework { baseName = "OpentelemetrySemanticConventions"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "OpentelemetrySemanticConventions"; xcf.add(this) }
    }
    iosSimulatorArm64 {
        binaries.framework {
            baseName = "OpentelemetrySemanticConventions"
            isStatic = true
            xcf.add(this)
        }
    }
    ...
    swiftExport {
        moduleName = "OpentelemetrySemanticConventions"
        flattenPackage = "io.github.kotlinmania.opentelemetrysemanticconventions"
    }

    android {
        namespace = "io.github.kotlinmania.opentelemetrysemanticconventions"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "opentelemetry-semantic-conventions-kotlin", version.toString())

    pom {
        name.set("opentelemetry-semantic-conventions-kotlin")
        description.set("Kotlin Multiplatform port of open-telemetry/opentelemetry-rust - Semantic conventions for OpenTelemetry")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/opentelemetry-semantic-conventions-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/opentelemetry-semantic-conventions-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/opentelemetry-semantic-conventions-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/opentelemetry-semantic-conventions-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleOpentelemetrySemanticConventionsXCFramework",
    "assembleOpentelemetrySemanticConventionsDebugXCFramework",
    "assembleOpentelemetrySemanticConventionsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleReleaseIosFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleDebugMacosFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleReleaseMacosFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleDebugTvosFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleReleaseTvosFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleDebugWatchosFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleReleaseWatchosFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForOpentelemetrySemanticConventionsXCFramework",
