# opentelemetry-semantic-conventions-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fopentelemetry--semantic--conventions--kotlin-blue.svg)](https://github.com/KotlinMania/opentelemetry-semantic-conventions-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/opentelemetry-semantic-conventions-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/opentelemetry-semantic-conventions-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/opentelemetry-semantic-conventions-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/opentelemetry-semantic-conventions-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-semantic-conventions).

**Original Project:** This port is based on [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-semantic-conventions). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
> The text below is reproduced and lightly edited from [`https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-semantic-conventions`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-semantic-conventions). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:opentelemetry-semantic-conventions-kotlin:0.1.2")
}
```
...
This Kotlin port is distributed under the same Apache-2.0 license as the upstream [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-semantic-conventions). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
...
Thanks to the [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-semantic-conventions) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
